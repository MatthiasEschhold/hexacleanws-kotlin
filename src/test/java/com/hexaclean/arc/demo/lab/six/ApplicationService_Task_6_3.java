...
public class ApplicationService_Task_6_3 extends BaseExerciseTest {
    ...
    void the_vehicle_supports_not_2G() {
        ...
        com.hexaclean.arc.demo.app.parts.catalogue.domain.model.Vehicle expectedVehicle =
                new com.hexaclean.arc.demo.app.parts.catalogue.domain.model.Vehicle(VIN, new VehicleModel(VEHICLE_MODEL_DESCRIPTION_TEST_VALUE, VEHICLE_MODEL_TYPE_TEST_VALUE), false);
        ...
        ExplosionChart explosionChart = appService.read(new PartsCategoryCode("123"), VIN);

        assertThat(explosionChart.getVehicle().getVehicleModel().getModelType()).isEqualTo(expectedVehicle.getVehicleModel().getModelType());
        assertThat(explosionChart.getVehicle().getVehicleModel().getModelDescription()).isEqualTo(expectedVehicle.getVehicleModel().getModelDescription());
        assertThat(vehicle.isHas2GSupport()).isEqualTo(expectedVehicle.getHas2GSupport());
    }
}
