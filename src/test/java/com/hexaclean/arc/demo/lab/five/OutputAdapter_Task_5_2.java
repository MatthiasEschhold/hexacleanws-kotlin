...
public class OutputAdapter_Task_5_2 extends BaseExerciseTest {
    ...
    void vehicle_and_vin_should_be_created_successful() {
        ...
        assertThat(vehicle.getVehicleMotionData().getLicensePlate()).isEqualTo(expectedVehicle.getVehicleMotionData().getLicensePlate().getValue());
        assertThat(vehicle.getVehicleMotionData().getMileage()).isEqualTo(expectedVehicle.getVehicleMotionData().getLicensePlate().getValue());
    }
