...
public class ArchitectureTest_Task_1_1 extends BaseArchUnitExerciseTest {
    ...
    void root_entity_check() {
        ArchRule rule = classes()
                ...
                .resideInAnyPackage(IO_GITHUB_DOMAINPRIMITIVES, VEHICLE_DOMAIN, VEHICLE_DOMAIN_MODEL, JAVA_LANG, JAVA_UTIL, KOTLIN)
                .andShould()
                .dependOnClassesThat()
    ...
    void value_object_check() {
        ArchRule rule = classes()
                ...
                .should()
                .onlyAccessClassesThat()
                .resideInAnyPackage(IO_GITHUB_DOMAINPRIMITIVES, JAVA_LANG, JAVA_UTIL, VEHICLE_DOMAIN, VEHICLE_DOMAIN_MODEL, KOTLIN);
        rule.check(classes);
    }
